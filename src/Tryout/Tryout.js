...
//                 <Link to='/' className='me-1 mx-1' id='amazon__logo'>
//                     <img width="100px" className='mx-3 mt-2'
//                         src='https://clipartcraft.com/images/amazon-smile-logo-transparent-background-7.png' alt='' />
//                 </Link>
//                 <div className="header__search d-flex flex-grow-1">
//                     <input className='header__searchInput form-control rounded-0'
//                         type="search" placeholder="Search" />
//                     <Link>
//                         <SearchIcon className='header__searchIcon me-2'
...
//                     </Link>
//                 </div>
//                 <div className='header__nav d-flex' id='header__nav'>
//                     {user ? (
//                         <Link className='header__link'>
//                             <div className='header__option' onClick={logout}>
//                                 <span className='header__optionLineOne'>Hello {user}</span>
...
//                         </div>
//                     </Link>
//                     <Link to='/checkout' className='header__link me-3 p-1'>
